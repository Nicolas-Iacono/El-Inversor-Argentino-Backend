...
//    }
    ...
    public User(Long id, String username, String email, String password, boolean accountNonLocked, boolean enabled, boolean accountNonLocked1, boolean accountNonExpired, List<SimpleGrantedAuthority> authorityList) {
    }
